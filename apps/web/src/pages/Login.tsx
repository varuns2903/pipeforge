    ...
    <div className="flex min-h-screen items-center justify-center bg-background canvas-bg relative">
      ...
      <div className="w-full max-w-sm z-10">
        <div className="text-center mb-10">
          <div className="w-12 h-12 mx-auto rounded-xl bg-accent-600 flex items-center justify-center mb-4 shadow-[0_0_20px_var(--color-accent-glow)]">
            <span className="text-white text-xl font-bold">DP</span>
          </div>
          <h2 className="text-2xl font-semibold text-text-primary tracking-tight">Sign in to pipeforge</h2>
          <p className="text-sm text-text-tertiary mt-2">Build data pipelines visually.</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                ...
                <Link to="/forgot-password" className="text-xs text-accent-500 hover:text-accent-400 font-medium transition-colors">Forgot password?</Link>
              </div>
              <input
                type="password"
                value={password}
        ...
        <p className="mt-8 text-center text-sm text-text-secondary">
          Don't have an account? <Link to="/register" className="text-accent-500 hover:text-accent-400 font-medium transition-colors">Create workspace</Link>
        </p>
      </div>
    </div>
  );
